...
<%@ include file ="../Common/Top.jsp" %>
	...
	<div class="contain">
		<div class="login ">
			...
			<form action="https://2bob.co.kr/process/mLogin.php" method="POST" id="login_form" onsubmit="return _onSubmit()">
				...
				<ul class="clr login_wrap">
					<li>
						<div class="login_box" id="login_type1">
							...
							<p class="no_login">
								<a href="#" onclick="window.open('https://2bob.co.kr/module/idpwsearch/search_id.php','','width=560,height=355,top='+(screen.availHeight/2-250)+',left='+(screen.availWidth/2-400)+',status=yes,scrollbars=no')">아이디 찾기</a><span class="line">|</span>
								<a href="#" onclick="window.open('https://2bob.co.kr/module/idpwsearch/search_pw.php','','width=560,height=410,top='+(screen.availHeight/2-250)+',left='+(screen.availWidth/2-400)+',status=yes,scrollbars=no')">비밀번호 찾기</a><span class="line">|</span>
