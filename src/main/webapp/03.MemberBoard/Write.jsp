				...
				<form action="WriteProccess.jsp" method="post" enctype="multipart/form-data" id="rBoardFrm">
					...
					<table cellspacing="0" summary="게시글 작성양식">
						...
						<tr>
							<th>내용</th>
							<td>
								<textarea id="rContent" name="rContent" rows="6" placeholder="레시피를 공유해주세요." class="join_input wd200" style="width:100%; height:50%"></textarea>
							</td>
						</tr>
						<tr>
							<th>첨부</th>
